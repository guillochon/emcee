...
class tEnsembleSampler(Sampler):
    """
    ...
    **Warning**: The :attr:`chain` member of this object has the shape:
    ...
    def __init__(self, nwalkers, dim, lnpostfn, a=2.0, args=[], kwargs={},
        ...
        if postargs is not None:
            args = postargs
        super(tEnsembleSampler, self).__init__(dim, lnpostfn, args=args,
                                              kwargs=kwargs)
    ...
    def reset(self):
        ...
        """
        super(tEnsembleSampler, self).reset()
    ...
    def sample(self, p0, lnprob0=None, rstate0=None, blobs0=None,
               iterations=1, thin=1, storechain=True, mh_proposal=None, temp=1.):
        """
    ...
    def _propose_stretch(self, p0, p1, lnprob0, temp):
        """
        ...
        * ``blob`` - The new meta data blobs or ``None`` if nothing was
        ...
        lnpdiff = (self.dim - 1.) * np.log(zz) + (newlnprob - lnprob0) + np.log(temp)
    ...
    def chain(self):
        ...
        """
        return super(tEnsembleSampler, self).chain
    ...
    def lnprobability(self):
        ...
        """
        return super(tEnsembleSampler, self).lnprobability
    ...
    def flatlnprobability(self):
        ...
        """
        return super(tEnsembleSampler, self).lnprobability.flatten()
    ...
    def acceptance_fraction(self):
        ...
        """
        return super(tEnsembleSampler, self).acceptance_fraction
